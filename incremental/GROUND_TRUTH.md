...
| V6.3 | F-31 EROFS + F-32 `/` guard + Stage 3 (wmctrl + gate asserts) | **TESTING** — 29/29 QEMU gates + smoke gate all green (incl. 5 new positive assertions: Environment=HOME, BindPaths, ProtectHome=tmpfs, wmctrl binary, MCPD_FS_READ_ROOTS symbol); ISO downloaded + hash-verified. UTM boot check pending | `ISO/incremental/v6.3.iso` | `3c094c4c…48e5` | — |
