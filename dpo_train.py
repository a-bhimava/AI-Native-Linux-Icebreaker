...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(BASE_DIR / "training/logs/dpo_train.log", mode="a"),
    ],
)
...
def detect_gpu():
    ...
    elif "L4" in name:          # 24 GB, bf16 capable
        return False, True, 4, 2
    elif "P100" in name:        # 16 GB
        return True, False, 2, 4
    elif "K80" in name:         # 12 GB, slow
        return True, False, 1, 8
    elif "P4" in name:          # 8 GB, tight
        return True, False, 1, 8
    else:                       # T4 (16 GB)
        return True, False, 2, 4
...
def main():
    ...
    sft_adapter = str(BASE_DIR / "training/adapters/sft/final")
    output_dir  = str(BASE_DIR / "training/adapters/dpo")
    dpo_file    = str(BASE_DIR / "data/dpo_pairs.jsonl")
