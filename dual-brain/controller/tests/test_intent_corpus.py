...
# backends, systemd checks, etc.).
#
# v6.9 Scope O Layer 1: the frozenset is now auto-generated by
# scripts/export_mcpd_catalogue.py from tool_catalogue.yaml. Do NOT
# hand-edit either file — add the tool to tool_catalogue.yaml and
# regenerate via `python scripts/export_mcpd_catalogue.py emit
# --from-categories`. The mismatch test at the bottom of this file
# also checks parity vs main.py's _SUPPORTED_ACTIONS.
from controller._intent_corpus_supported import SUPPORTED_ACTIONS as _SUPPORTED_ACTIONS
